...
const AddTouristsSpot = () => {
    ...
    const handleAddSpot = (data) =>{
        ...
        const {countryName, spotName, image, location, description, average, seasonality, travelTime, totalVisitor} = data;
    ...
    return (
        <div className="container mx-auto px-5">
            <h1 className="text-xl md:text-2xl text-center font-semibold mt-5">Add A Tourist Spot</h1>
            <div>
                <form onSubmit={handleSubmit(handleAddSpot)} className="mt-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 md:gap-3">
                        <div>
                            <select className="px-5 py-2 bg-red-50 w-full my-1 placeholder:text-gray-800 placeholder:font-semibold text-gray-950 font-semibold" {...register("countryName" , { required: true })}>
                        ...
                        <div>
                            <input className="px-5 py-2 bg-red-50 w-full my-1 placeholder:text-gray-800 placeholder:font-semibold text-gray-950 font-semibold" type="text" placeholder="Tourist Spot Name" name="spotName" {...register("spotName", { required: true })} />
                            {errors.spotName && <span className="font-medium text-red-500 ml-5">This field is required</span>}
                        </div>
                        <div>
                            <input className="px-5 py-2 bg-red-50 w-full my-1 placeholder:text-gray-800 placeholder:font-semibold text-gray-950 font-semibold" type="text" placeholder="Image URL" name="image" {...register("image", { required: true })} />
                            {errors.image && <span className="font-medium text-red-500 ml-5">This field is required</span>}
                        </div>
                        <div>
                            <input className="px-5 py-2 bg-red-50 w-full my-1 placeholder:text-gray-800 placeholder:font-semibold text-gray-950 font-semibold" type="text" placeholder="Location" name="location" {...register("location", { required: true })} />
                            {errors.location && <span className="font-medium text-red-500 ml-5">This field is required</span>}
                        </div>
                        <div className="md:col-span-2">
                            <input className="px-5 py-2 bg-red-50 w-full my-1 placeholder:text-gray-800 placeholder:font-semibold text-gray-950 font-semibold col-span-2" type="text" placeholder="Sort Description" name="description" {...register("description", { required: true })} />
                            {errors.description && <span className="font-medium text-red-500 ml-5">This field is required</span>}
                        </div>
                        <div>
                            <input className="px-5 py-2 bg-red-50 w-full my-1 placeholder:text-gray-800 placeholder:font-semibold text-gray-950 font-semibold" type="text" placeholder="Average Cost" name="average" {...register("average", { required: true })} />
                            {errors.average && <span className="font-medium text-red-500 ml-5">This field is required</span>}
                        </div>
                        <div>
                            <select className="px-5 py-2 bg-red-50 w-full my-1 placeholder:text-gray-800 placeholder:font-semibold text-gray-950 font-semibold" {...register("seasonality", { required: true })}>
                        ...
                        <div>
                            <select className="px-5 py-2 bg-red-50 w-full my-1 placeholder:text-gray-800 placeholder:font-semibold text-gray-950 font-semibold" {...register("travelTime", { required: true })}>
                        ...
                        <div>
                            <select className="px-5 py-2 bg-red-50 w-full my-1 placeholder:text-gray-800 placeholder:font-semibold text-gray-950 font-semibold" {...register("totalVisitor", { required: true })}>
